...
RSpec.describe GiftCardsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested gift_card as @gift_card" do
      gift_card = GiftCard.create! valid_attributes
      get :show, {:id => gift_card.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested gift_card as @gift_card" do
      gift_card = GiftCard.create! valid_attributes
      get :edit, {:id => gift_card.to_param}, valid_session
      expect(assigns(:gift_card)).to eq(gift_card)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new GiftCard" do
        expect {
          post :create, {:gift_card => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved gift_card as @gift_card" do
        post :create, {:gift_card => invalid_attributes}, valid_session
        expect(assigns(:gift_card)).to be_a_new(GiftCard)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested gift_card" do
        gift_card = GiftCard.create! valid_attributes
        put :update, {:id => gift_card.to_param, :gift_card => new_attributes}, valid_session
        gift_card.reload
      ...
      it "assigns the requested gift_card as @gift_card" do
        gift_card = GiftCard.create! valid_attributes
        put :update, {:id => gift_card.to_param, :gift_card => valid_attributes}, valid_session
        expect(assigns(:gift_card)).to eq(gift_card)
      end
    ...
    context "with invalid params" do
      it "assigns the gift_card as @gift_card" do
        gift_card = GiftCard.create! valid_attributes
        put :update, {:id => gift_card.to_param, :gift_card => invalid_attributes}, valid_session
        expect(assigns(:gift_card)).to eq(gift_card)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested gift_card" do
      gift_card = GiftCard.create! valid_attributes
      expect {
        delete :destroy, {:id => gift_card.to_param}, valid_session
      }.to change(GiftCard, :count).by(-1)
    end
