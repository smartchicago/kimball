class DashboardController < ApplicationController
  def index
    ...
    @top_five_wards     = Person.count(group: :geography_id, order: 'count_all DESC', limit: 5)
    @bottom_five_wards  = Person.count(group: :geography_id, order: 'count_all ASC', limit: 5)
  end
end
